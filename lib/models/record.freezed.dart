...
abstract class $RecordCopyWith<$Res> {
  ...
  @useResult
  $Res call({int weight, DateTime date, String? note, String? photoUrl});
}
...
class _$RecordImpl with DiagnosticableTreeMixin implements _Record {
  _$RecordImpl(
      {required this.weight, required this.date, this.note, this.photoUrl});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Record(weight: $weight, date: $date, note: $note, photoUrl: $photoUrl)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, weight, date, note, photoUrl);
